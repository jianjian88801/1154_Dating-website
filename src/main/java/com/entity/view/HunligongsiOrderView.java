...
public class HunligongsiOrderView extends HunligongsiOrderEntity implements Serializable {
	...
	public HunligongsiOrderView() {

	}

	public HunligongsiOrderView(HunligongsiOrderEntity hunligongsiOrderEntity) {
		try {
			BeanUtils.copyProperties(this, hunligongsiOrderEntity);
