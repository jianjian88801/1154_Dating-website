...
public class XiangqinCollectionView extends XiangqinCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String xiangqinCollectionValue;
	...
	public XiangqinCollectionView() {

	}

	public XiangqinCollectionView(XiangqinCollectionEntity xiangqinCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, xiangqinCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getXiangqinCollectionValue() {
				return xiangqinCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setXiangqinCollectionValue(String xiangqinCollectionValue) {
				this.xiangqinCollectionValue = xiangqinCollectionValue;
			}
