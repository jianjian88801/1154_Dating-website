...
var centerMenu = [
    ...
    ,{
        name: '婚礼公司收藏',
        url: '../hunligongsiCollection/list.html'
    }
    ,{
        name: '婚礼公司预约',
        url: '../hunligongsiOrder/list.html'
    }
    ,{
        name: '结婚案例收藏',
        url: '../jiehunanliCollection/list.html'
    }
    ,{
        name: '相亲收藏',
        url: '../xiangqinCollection/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '婚礼公司',
        url: './pages/hunligongsi/list.html'
    },
    {
        name: '结婚案例',
        url: './pages/jiehunanli/list.html'
    },
    {
        name: '相亲',
        url: './pages/xiangqin/list.html'
    },

]

var adminurl =  "http://localhost:8080/xiangqinwangzhan/admin/dist/index.html#/login";
